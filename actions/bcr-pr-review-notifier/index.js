...
async function run() {
  ...
  if (modulesWithoutGithubMaintainers.size > 0) {
    ...
    await postComment(octokit, owner, repo, prNumber, `Hello @meteorcloudy, modules without existing maintainers (${modulesList}) have been updated in this PR. Please review the changes.`);
  }
}
